package com.qinchy.shirodemo2biz.controller;
...
import com.qinchy.shirodemo2dao.model.ResponseData;
	...
	public String delFunction(String  id) {
		...
		try {
			...
			if(list!=null&&!list.isEmpty()){
				ResponseData.setMsg("existChildren");//存在子节点
			}else {
			...
			ResponseData.setMsg("existRoleFunction");
		}
		catch (Exception e) {
			ResponseData.setMsg("exception");
			log.info(e.toString());
